...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section
        className="py-12 px-4 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden"
        style={{
          background:
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 justify-items-center max-w-4xl mx-auto">
            {/* First TikTok Video */}
            <div
